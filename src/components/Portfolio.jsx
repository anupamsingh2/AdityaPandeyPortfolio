...
const CVSection = () => {
  return (
    <motion.div variants={fadeIn("left", "spring", 0.5, 0.75)} className="w-full lg:w-2/3 mx-auto">
...
const Portfolio = () => {
  return (
    <>
      ...
      {/* Social Links */}
      <div className="flex justify-between mt-6 mb-8 flex-wrap gap-3">
        <a 
          href="https://github.com/Adizshiva" 
          target="_blank" 
        ...
        <a 
          href="https://leetcode.com/u/adipandey861/" 
          target="_blank" 
          rel="noopener noreferrer"
        ...
        <a 
          href="https://www.hackerrank.com/profile/adipandey861" 
          target="_blank" 
          rel="noopener noreferrer"
        ...
        <a 
          href="https://www.linkedin.com/in/adityazspandey/" 
          target="_blank" 
          rel="noopener noreferrer"
      ...
      <div className="flex w-full">
        ...
        >
          Below you'll find my professional credentials, including my detailed CV.
          This represents my professional journey, skill set, and personality better than words alone could express.
        </motion.p>
      </div>
